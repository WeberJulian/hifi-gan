...
def train(rank, a, h):
    ...
    trainset = MelDataset(h, training_filelist, h.segment_size, h.n_fft, h.num_mels,
    ...
    if rank == 0:
        validset = MelDataset(h, validation_filelist, h.segment_size, h.n_fft, h.num_mels,
                        ...
                        for j, batch in enumerate(validation_loader):
                            ...
                            if j <= 4:
                                if steps == 0:
                                    ...
                                    y_spec = mel_spectrogram(y.squeeze(1), h.n_fft, h.num_mels,
                                ...
                                x_spec = mel_spectrogram(x.squeeze(1), h.n_fft//2, 80,
                                                            h.sampling_rate//3, h.hop_size//2, h.win_size//2,
                                                            h.fmin, h.fmax_for_loss)
